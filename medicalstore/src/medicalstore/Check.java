...
public class Check extends JFrame implements ActionListener{
	...
	Check()
	{
		...
		String colhead[]= {"ProductName","CompanyName","MfgDate","ExpiryDate","BatchNumber"};
		...
		try
		{
			Class.forName("com.mysql.jdbc.Deriv").newInstance();
			c1 = DriverManager.getConnection("jdbc:mysql://localhost/medical","root","");
			pst=c1.prepareStatement("select * from Expirycheck");
			rs=pst.executeQuery();
			int r=0;
