...
if(c.equals(""))
  {
     JOptionPane.showMessageDialog(this,"Enter MfgDate");
  }
else if(d.equals(""))
   {
       JOptionPane.showMessageDialog(this,"Enter ExpiryDate");
   }
else if(e.equals(""))
{
       JOptionPane.showMessageDialog(this,"Enter BatchNumber");
}
else
{
pst=c1.prepareStatement("insert into Expirycheck values(?,?,?,?,?)");
pst.setString(1,a);
pst.setString(2,b);
pst.setString(3,c);
pst.setString(4,d);
